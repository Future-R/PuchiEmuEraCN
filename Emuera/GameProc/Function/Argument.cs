...
namespace MinorShift.Emuera.GameProc.Function
{
	...
	//フェード機能
    internal sealed class SpFadeArgument : Argument
    {
        public SpFadeArgument(IOperandTerm alpha, IOperandTerm groupID, IOperandTerm speed, IOperandTerm color)
        {
            Terms[0] = alpha;
            Terms[1] = groupID;
            Terms[2] = speed;
        ...
        readonly public IOperandTerm[] Terms = new IOperandTerm[4];
    }
	//画像シェイク機能
    internal sealed class SpShakeArgument : Argument
    {
        public SpShakeArgument(IOperandTerm effectCoef, IOperandTerm shakeQT, IOperandTerm groupID, IOperandTerm speed)
        {
            Terms[0] = effectCoef;
            Terms[1] = shakeQT;
            Terms[2] = groupID;
